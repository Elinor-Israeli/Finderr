                ...
                <div className="container">
                    <div className="top main-layout">
                        ...
                        <div className="item">
                            <ul>
                                <h2>For Clients</h2>
                                <li><a href="#" target="_blank" rel="noopener noreferrer">Visit Example</a></li>
                    ...
                    <div className="bottom">
                        ...
                        <div className="right">
                            <div className="social">
                                <a href="https://www.tiktok.com/fiverr/"><img src="/img/tiktok.svg" alt="ny" /></a>
                                ...
                                <a href="https://www.pinterest.com/fiverr/"> <img src="/img/pinterest.png" alt="" /></a>
                                <a href="https://www.instagram.com/fiverr/"> <img src="/img/instagram.png" alt="" /></a>
                            </div>
                            <div className="link">
