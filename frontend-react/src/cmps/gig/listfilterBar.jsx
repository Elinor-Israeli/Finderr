...
//             <div className={`top-filter-bar__filter-menu top-filter-bar__filter-delivery ${checkedDelivery !== '' ? 'top-filter-bar__active-filter' : ''}`} ref={deliveryRef}>
...
//             {/* Budget Filter */}
//             <div className={`top-filter-bar__filter-menu top-filter-bar__filter-price ${filterByFromStore.minPrice !== '' || filterByFromStore.maxPrice !== '' ? 'top-filter-bar__active-filter' : ''}`} ref={ref}>
...
//                 {isPriceFilterShown && (
//                     <form className="top-filter-bar__price-filter-scroll">
